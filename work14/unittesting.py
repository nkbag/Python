...
class TestCaseName(unittest.TestCase):
    ...
    def test_simple_number(self):
        self.assertEqual(number_check(1, 0, 100000), "Число является простым")

    def test_composite_number(self):
        self.assertEqual(number_check(99999, 0, 100000), "Число является составным")

    def test_wrong_number(self):
        self.assertEqual(number_check(100001, 0, 100000), "Введённое число не входит в заданный диапазон")

    def test_dec_to_hex_5(self):
        self.assertEqual(hex(5), "result='5'")

    def test_dec_to_hex_1204(self):
        self.assertEqual(hex(1204), "result='4B4'")
